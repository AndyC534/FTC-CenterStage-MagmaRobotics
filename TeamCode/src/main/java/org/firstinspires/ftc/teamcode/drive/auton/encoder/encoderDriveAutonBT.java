...
//
//
//@Autonomous(name="encoderAutonBT", group="Autonomous")
////@Disabled
//public class encoderDriveAutonBT extends LinearOpMode {
//
...
//        encoderDrive(TURN_SPEED, -2, 2, 0.5);  // S3: Turn left 2 inches with 0.5 sec timeout
