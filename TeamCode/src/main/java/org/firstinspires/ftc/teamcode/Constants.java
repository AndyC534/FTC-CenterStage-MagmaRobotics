...
public class constants {
    ...
    public static final class Button {
        public static final String frontLeftMotor = "frontLeftMotor";
        ...
        public static final String upDownMotor = "liftUpDownMotor";
        public static final String frontBackMotor = "frontBackMotor";
...
//        public static final String climbHookServo = "climbHookServo";
        public static final class Time {
            ...
            public static final int autonTime = 30;
        }
    }
}
